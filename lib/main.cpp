...
int main() {
  ...
  string path[32] = {"img/А.png", "img/Б.png", "img/В.png", "img/Г.png",
                     "img/Д.png", "img/Е.png", "img/Ж.png", "img/З.png",
                     "img/И.png", "img/Й.png", "img/К.png", "img/Л.png",
                     "img/М.png", "img/Н.png", "img/О.png", "img/П.png",
                     "img/Р.png", "img/С.png", "img/Т.png", "img/У.png",
                     "img/Ф.png", "img/Х.png", "img/Ц.png", "img/Ч.png",
                     "img/Ш.png", "img/Щ.png", "img/Ь.png", "img/Ы.png",
                     "img/Ъ.png", "img/Э.png", "img/Ю.png", "img/Я.png"};
      ...
      case (0): {
        ...
        if (Mouse::isButtonPressed(Mouse::Left)) {
          ...
          if ((pos_x >= 250) && (pos_x <= 750) && (pos_y >= 350) &&
              (pos_y <= 460)) {
            button = 1;
          } else if ((pos_x >= 250) && (pos_x <= 750) && (pos_y >= 514) &&
                     (pos_y <= 621)) {
            button = 2;
          }
        }
